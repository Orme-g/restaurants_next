...
import type { IRestaurantSearchCriteria } from "@/shared/validators/restaurants";
import type { TRestaurantSortCriteria } from "@/shared/types/restaurants";
...
export async function updateRestaurantRating(
    ...
    const { rating: ratingMarksArray } = restaurant;
    ratingMarksArray.push(rating);
